...
const VerifyPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-indigo-50/20 text-slate-800 flex flex-col items-center justify-between font-sans relative overflow-hidden">
      {/* Decorative ambient background accents */}
      <div className="absolute top-0 right-0 w-[40%] h-[30%] bg-indigo-200/20 rounded-full blur-[100px] pointer-events-none"></div>
      <div className="absolute bottom-12 left-0 w-[45%] h-[35%] bg-blue-100/20 rounded-full blur-[100px] pointer-events-none"></div>
      ...
      <main className="flex-1 w-full max-w-4xl px-4 py-12 flex flex-col items-center justify-center">
        ...
        <div className="w-full max-w-2xl bg-white border border-slate-200 rounded-2xl shadow-xl p-8 md:p-10 relative overflow-hidden">
          {/* Accent Line */}
          ...
          <div className="space-y-4 max-w-md mx-auto">
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-5 py-4 border-2 border-slate-200 rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:border-indigo-600 focus:ring-4 focus:ring-indigo-100 transition-all duration-200 font-mono text-center text-lg tracking-widest uppercase font-bold"
                />
            ...
            <button
              ...
              disabled={loading}
              className={`w-full py-4 rounded-xl font-extrabold text-white text-base shadow-md transition-all duration-200 flex items-center justify-center gap-2 ${
                loading
                  ? "bg-slate-400 cursor-not-allowed"
                  : "bg-indigo-600 hover:bg-indigo-700 active:scale-[0.98] shadow-indigo-600/10 hover:shadow-indigo-600/20"
              }`}
            >
              {loading ? (
                <>
          ...
          {certificate && (
            <div className="mt-10 pt-8 border-t border-slate-200 animate-slideIn">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-slate-50 p-4 border border-slate-100 rounded-xl">
                    ...
                    <span className="font-mono text-indigo-600 font-extrabold text-sm uppercase tracking-widest">{certificate.uniqueId}</span>
                  </div>
                </div>
              ...
              <div className="mt-8 pt-6 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="flex items-center space-x-2 bg-indigo-50 border border-indigo-100 rounded-lg px-3 py-1.5 text-indigo-600">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-4 h-4">
