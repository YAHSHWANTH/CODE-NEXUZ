        ...
        <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {features.map((feature, index) => (
            <div
              ...
              className={`bg-white p-6 rounded-xl border border-gray-100 shadow-md codevia-card-hover hover:border-purple-300 cursor-pointer text-center group flex flex-col justify-between scroll-reveal-card delay-${index + 1}`}
            >
              <div>
